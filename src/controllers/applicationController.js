...
class ApplicationController {
	...
	addProject = (project) => {
		...
		renderController.refreshAllProjects(
			databaseController.getAllProjects()
		);
	};
	...
	refreshTodos() {
		if (this.sortBy === "none")
			return renderController.refreshAllTodos(
				databaseController.getTodosByTab(this.tab)
			);
		renderController.refreshAllTodos(
			databaseController.getSortedTodos(
				this.sortBy,
				databaseController.getTodosByTab(this.tab)
			)
		);
